...
### For this the bucket should have all public access blocked along with the individual objects inside the bucket. 
  ...
  - Under object ownership chose edit and selected 'ACLs disabled' and saved the changes
  ...
  - Changed the public access settings by editing the Block Public Access (bucket settings)
  ...
  - Blocked all public access and confirmed the changes
...
##
##
  - Opened Cloudfront to create distribution
  ...
  - Chose S3 from the options for origin types
